...
@section('content')
    @component('common-components.breadcrumb')
        @slot('title') Kategori Menu @endslot
    @endcomponent
    @include('menu_kategori.modalBuat')
    <div class="row">
        <div class="col-12">
            <div class="card">
...
@section('script')
    ...
    <script>
        ...
        var table = $('.datatable').DataTable({
            processing: true,
            serverSide: true,
            ajax: "{{ route('menu.kategori') }}",
            columns: [
                // {data: 'no', name: 'no'},
                {data: 'menu_kategori', name: 'menu_kategori'},
                {data: 'menu', name: 'menu'},
        ...
        $('#upload-form').submit(function(e) {
            ...
            $.ajax({
                type:'POST',
                url: "{{ route('menu.kategori.simpan') }}",
                data: formData,
                contentType: false,
                processData: false,
                success: (result) => {
