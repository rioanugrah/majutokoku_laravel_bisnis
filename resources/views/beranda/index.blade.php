                        ...
                        <div class="col-sm-6">
                            <div>
                                <div class="row">
                                    <div class="col-6">
                                        <div class="py-3">
                                            <p class="mb-1 text-truncate"><i class="mdi mdi-circle text-primary mr-1"></i>
                                                Online</p>
                                            <h5>$ 2,652</h5>
                                        </div>
                                    </div>
                                    <div class="col-6">
                                        <div class="py-3">
                                            <p class="mb-1 text-truncate"><i class="mdi mdi-circle text-success mr-1"></i>
                                                Offline</p>
                                            <h5>$ 2,284</h5>
                                        </div>
                                    </div>
                                    <div class="col-6">
                                        <div class="py-3">
                                            <p class="mb-1 text-truncate"><i class="mdi mdi-circle text-warning mr-1"></i>
                                                Marketing</p>
                                            <h5>$ 1,753</h5>
                                        </div>
                                    </div>
            ...
            <div class="card bg-primary">
                <div class="card-body">
                    ...
                    <div class="row justify-content-end">
                        <div class="col-8">
                            <div class="mt-4">
                                <img src="public/images/widget-img.png" alt="" class="img-fluid mx-auto d-block">
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div id="reviewExampleControls" class="carousel slide review-carousel" data-ride="carousel">
                        ...
                        <div class="carousel-inner">
                            ...
                            <div class="carousel-item">
                                <div>
                                    <p>For science, music, sport, etc, Europe uses the same vocabulary languages only differ
                                        in their grammar</p>
                                    <div class="media mt-4">
                                        <div class="avatar-sm mr-3">
                                            <img src="public/images/users/avatar-4.jpg" alt=""
